...
byte ip[] = { 192, 168, 0, 100 };		    // this is the ip within my lan
...
void setup()
{
  ...
  if (client.connect()) {
    ...
    client.println("Content-length: 38");					 // this is the length of the text "Yahoo, im twittering!"
    client.println("Connection: Close");
    client.println();
    client.print("status=Tweet, Tweet, Tweet! says the arduino.");
  } else {
